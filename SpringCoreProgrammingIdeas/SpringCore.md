...
![1604974821968](SpringCore.assets/1604974821968.png)
...
| 自定义         | 通过 Java Properties java.protocol.handler.pkgs 指定实现类包名，实 现类名必须为“Handler”。如果存在多包名指定，通过分隔符 “\|” |
...
##  Spring 泛型处理（Generic Resolution）
