...
import org.copydays.rmliu.cache.cluster.ClusterJedis;
import org.copydays.rmliu.cache.sentinel.SentinelJedis;
...
//		jedis.set("uptime1", new Long(System.currentTimeMillis()).toString());
//		System.out.println(jedis.get("uptime1"));
